...
exports.getDeviceInfos = getDeviceInfos;
const topkat_utils_1 = require("topkat-utils");
const init_1 = require("./init");
let deviceId = (0, topkat_utils_1.generateObjectId)();
let retryTimeout;
...
const infosFromNavigator = ['appCodeName', 'oscpu', 'language', 'languages', 'product', 'vendor', 'productSub'];
    ...
    retryTimeout = setTimeout(async () => {
        if (!deviceId)
            ...
            try {
                ...
                await (0, init_1.get$)().registerUserDevice(getDeviceInfos());
            }
            catch (err) {
                err.isHandled = true;
...
//# sourceMappingURL=device.web.js.map