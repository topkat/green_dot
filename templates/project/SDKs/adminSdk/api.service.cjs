...
const $ = new Proxy({
    init: (props) => {
        ...
        init({ ...otherProps, headers: { apiKey, platform: 'admin' } })
    },
...
$.addQueriesToInvalidate.manageDueDiligenceStatusAsAdmin(['user*'])
$.addQueriesToInvalidate.manageKycStatusAsAdmin(['user*'])
$.addQueriesToInvalidate.updateEmail(['user*'])
$.addQueriesToInvalidate.sendValidationEmail(['user*'])
$.addQueriesToInvalidate.icoTransactionSuccessHandler(['icoTransaction*'])
$.addQueriesToInvalidate.cbwaa(['bangkWallets*'])
$.addQueriesToInvalidate.createIcoBonusCode(['icoBonusCode*'])
