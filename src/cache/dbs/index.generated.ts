...
import { AllModels as MainDbAllModels } from './mainDb.modelTypes.generated.js'
...
export type ModelsWithDbNamesAndReadWrite = {
    ...
    default: { [K in keyof MainDbAllModels]: K extends 'user' ? MainDbAllModels[K] & { Read: UserPermissionFields & UserAdditionalFieldsRead, Write: Partial<UserPermissionFields & UserAdditionalFieldsWrite> } : MainDbAllModels[K] }
}
